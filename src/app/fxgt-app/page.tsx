...
export const metadata = {
  title: "FXGT App — FXGT",
  description:
    "Trade anywhere anytime with the FXGT mobile app. Get lightning-fast execution, market access and a polished, intuitive interface.",
};
...
export default function FxgtAppPage() {
  ...
  const faqs = [
    {
      q: "Do I need an MT5 account to use the FXGT App?",
      a: "No — the FXGT App works with your FXGT account. You can open, fund and manage demo or live accounts directly inside the app.",
    },
    {
      q: "How do I login to the FXGT App?",
      a: "Use your FXGT account email and password. We also support two-factor authentication (2FA) for added security.",
    },
    {
    ...
    {
      q: "What advanced chart types can I access with FXGT.com?",
    ...
    {
      q: "Can I access real-time market data on FXGT.com Trader?",
      a: "Yes — the app provides real-time price feeds for supported instruments so you can trade with up-to-date market information.",
    },
    {
      q: "How secure is my account and personal information on the FXGT App?",
    ...
    {
      q: "What payment methods can I use to fund my FXGT App account?",
    ...
    {
      q: "Can I trade in my language with the FXGT App?",
      a: "The app supports multiple languages — check the settings to select your preferred language.",
    },
    {
      q: "What happens if I lose internet connection while trading on the FXGT App?",
    ...
    {
      q: "Can I benefit from FXGT.com’s bonuses and rewards with the Mobile App?",
      ...
      <main className="bg-white text-slate-900">
        ...
        <section className="relative py-20 h-[100vh]">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl lg:text-5xl font-display font-bold text-white">FXGT App: <br/>Trade Anywhere, Anytime.</h1>
                <p className="mt-6 text-lg text-slate-200 max-w-2xl">
                  Experience ultimate trading freedom on a mobile app with lightning-fast execution, broad market access, and an intuitive interface.
                </p>
        ...
        <section className="py-16 bg-slate-50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="text-center mt-2 text-slate-600">Enjoy trading on the GO with a powerful Mobile App</p>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h3 className="text-3xl text-slate-800 font-semibold">Discover your personal trading assistant</h3>
              <p className="mt-4 text-slate-600">Trade across 500+ markets with an app that assists you with:</p>

              <ul className="mt-6 space-y-4">
                <li className="flex items-start gap-3">
                  <div className="mt-1 h-6 w-6 rounded-full bg-[#0f766e] text-white flex items-center justify-center">✓</div>
                  <div>
                    <strong>Customizable Alerts:</strong>
                    <div className="text-slate-600">Set price and market alerts to trade exactly when you need to.</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 h-6 w-6 rounded-full bg-[#0f766e] text-white flex items-center justify-center">✓</div>
        ...
        <section className="py-12 bg-slate-50">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="rounded-2xl bg-black text-white p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                <h4 className="text-2xl font-semibold">Start Trading Today</h4>
                <p className="mt-2 text-slate-300">Download the FXGT.com app</p>
              </div>
            ...
            <div className="mt-8 rounded-xl bg-white p-6 border border-slate-100">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h6 className="text-teal-700 font-semibold">iOS</h6>
                ...
                <div>
                  <h6 className="text-teal-700 font-semibold">Android</h6>
                  <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-slate-600">
                    <div>Phone</div>
